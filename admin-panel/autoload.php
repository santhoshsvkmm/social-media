...
if ($is_moderoter && !empty($wo['user']['permission'])) {
    ...
    if (!isset($wo['user']['permission'][$page])) {
    ...
    elseif ($wo['user']['permission'][$page] == 0) {
...
if ($notify_count > 0) {
    $notifications = $db->where('recipient_id',0)->where('admin',1)->where('seen',0)->orderBy('id','DESC')->get(T_NOTIFICATION,10);
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo(Wo_LoadAdminLink('assets/css/admin-optimized.css')) ?>" type="text/css">
...
<!-- App css -->
    ...
    <!-- Main scripts -->
<script src="<?php echo(Wo_LoadAdminLink('vendors/bundle.js')) ?>" defer></script>

    <!-- Apex chart -->
    <script src="<?php echo(Wo_LoadAdminLink('vendors/charts/apex/apexcharts.min.js')) ?>" defer></script>

    <!-- Daterangepicker -->
    <script src="<?php echo(Wo_LoadAdminLink('vendors/datepicker/daterangepicker.js')) ?>" defer></script>

    <!-- DataTable -->
    <script src="<?php echo(Wo_LoadAdminLink('vendors/dataTable/datatables.min.js')) ?>" defer></script>
